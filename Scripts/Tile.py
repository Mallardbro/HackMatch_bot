...
class Tile:
    ...
    def draw(self, _image):
        ...
        if self.pip:
            ...
            cv2.putText(_image, str(self.index), (x + 14, y + 42), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255))
        else:
            w, h = 92, 65
            cv2.rectangle(_image, (x, y), (x + w, y + h), colours[self.colour], -1)
            cv2.putText(_image, str(self.index), (x + 25, y + 40), cv2.FONT_HERSHEY_COMPLEX, 1,
                        (255, 255, 255))
